package com.example.sping02_jpademo.part01.controller;
...
import com.example.sping02_jpademo.part01.service.MemService;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	public ResponseEntity<Integer> insertMemByNative(@RequestBody MemDTO mem) {
		// return
		// ResponseEntity.ok().body(memService.insertMemByNative(mem.getName(),mem.getAge(),mem.getLoc()));
		return ResponseEntity.ok().body(memService.insertMemByNative(mem));
	}

//////////////////////////////////////////////////////////////////////////////////////////
	// {"num": 9, "name": "젝슨황", "age": 50, "loc": "뉴욕"}
	// {"num": 9, "name": "머스크", "age": 50, "loc": "뉴욕"}
	// http://localhost:8090/mem
	...
	// http://localhost:8090/mem/9
	@DeleteMapping(value = "/mem/{num}")
	public ResponseEntity<Integer> delateMem(@PathVariable("num") int num) {
		return ResponseEntity.ok().body(memService.delateMem(num));
	}
